...
\input{Chap1-TheorieDesGraphes/Figures/GrapheBiparti.tikz}
...
\input{Chap1-TheorieDesGraphes/Figures/SquareBiparti.tikz}
...
\begin{figure}[!tbph]
  ...
  \hfill
  \begin{minipage}[b]{0.4\textwidth}
    \input{Chap1-TheorieDesGraphes/Figures/GrayCube.tikz}
  \end{minipage}
\end{figure}
...
\end{exmp}
\input{Chap1-TheorieDesGraphes/Figures/CyclesAreteDisjointe.tikz}
...
\input{Chap1-TheorieDesGraphes/Figures/K5ValuedGraph.tikz}
...
\end{exmp}
\input{Chap1-TheorieDesGraphes/Figures/K5ValuedGraphWithPath.tikz}
...
\input{Chap1-TheorieDesGraphes/Figures/KonigCouplageTransversal.tikz}
...
\input{Chap1-TheorieDesGraphes/Figures/CouplageMax.tikz}
