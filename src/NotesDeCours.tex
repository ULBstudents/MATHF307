...
\declaretheorem[name=Définition,shaded={bgcolor=Gray}]{defn}

\declaretheorem[name=Théorème,shaded={bgcolor=Gray}]{thrm}

\declaretheorem[name=Proposition,shaded={bgcolor=Gray}]{prop}
